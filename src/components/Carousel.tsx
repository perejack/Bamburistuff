...
const slides = [
  {
    image: '/images/bamburi-history.jpg-1.webp',
    title: 'Bamburi Cement: Building Kenya',
    subtitle: 'Trusted for Generations',
    cta: 'Explore Bamburi Cement',
    description: 'Delivering quality and strength for over 60 years.',
    backgroundColor: 'from-green-900 to-green-700'
  },
  {
    image: '/images/053d5062de1a0354-2.jpeg',
    title: 'Modern Manufacturing',
    subtitle: 'State-of-the-art Cement Plants',
    cta: 'Learn More',
    description: 'Innovation and sustainability at every step.',
    backgroundColor: 'from-green-800 to-green-500'
  },
  {
    image: '/images/3eb29bba3143587c-3.jpeg',
    title: 'Nationwide Impact',
    subtitle: 'Building Landmarks and Homes',
    cta: 'See Our Projects',
    description: 'From iconic buildings to your home foundation.',
    backgroundColor: 'from-green-700 to-green-400'
  },
  {
    image: '/images/bamburi-cement-1-1622208283.profileImage.2x-jpg-webp-webp-4.webp',
    title: 'Sustainable Solutions',
    subtitle: 'Eco-Friendly Cement Production',
    cta: 'Our Commitment',
    description: 'Leading the way in green construction.',
    backgroundColor: 'from-green-900 to-green-700'
  },
  {
    image: '/images/20250311_113715-scaled-e1741708673322-5.jpg',
    title: 'Your Trusted Partner',
    subtitle: 'Reliable Supply, Every Time',
    cta: 'Contact Us',
    description: 'Order Bamburi Cement with confidence.',
    backgroundColor: 'from-green-900 to-green-700'
  },
];
        ...
        >
          ...
          <div className="absolute inset-0 flex items-center">
            <div className="px-8 md:px-16 max-w-3xl">
              ...
              <button className="bg-green-600 hover:bg-green-700 text-white px-6 py-3 rounded-lg font-semibold transition-all hover:scale-105 active:scale-95 duration-200 transform">
                {slide.cta}
              </button>
            </div>
          </div>
